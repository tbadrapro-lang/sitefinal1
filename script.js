...
const galleryImages = [
  ...
  { src: '3.png', alt: 'Salle' },
  { src: '4.png', alt: 'Terrasse' },
  { src: '5.png', alt: 'Dessert' },
  { src: '8.png', alt: 'Service' },
  { src: 'unnamed.png', alt: 'Planche' },
  { src: 'unnamed.png', alt: 'Bar' },
];
      ...
      <div class="container">
        <div class="split-section" data-aos="fade-up">
          <div class="split-image">
            <img src="1.png" alt="Ambiance" onerror="this.style.display='none'">
          </div>
...
function renderMenuCategory(title, items) {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('app').innerHTML = renderHero() + renderExperience() + renderMenu() + renderGallery() + renderInfo() + renderReviews() + renderReservation();
